...
messages = [
    ...
    "",
    "**Hello à toutes !\n\n__Avertissement: nous aborderons des sujets difficiles aujourd’hui, comme les atteintes à l’intégrité physique. Pour celles qui ne voudraient pas du tout participer à la discussion, il est recommandé de se reconnecter demain. Pour les autres, l’objectif est de créer un espace de confiance. L’équipe de modération sera là pour y veiller avec votre aide.__\n\nDans le cadre de tes études universitaires, as-tu déjà été la cible de propos, sous-entendus ou attitudes à caractère sexuel qui t’ont mise mal à l’aise ?\nAs-tu été l’objet de propositions sexuelles insistantes ?\nSi oui, penses-tu que ça pourrait se reproduire ? Si non, penses-tu que ça pourrait arriver dans le cadre de ta scolarité ?**",
    "Quel est le sentiment qui prédomine dans ces cas-là ? La colère ? Le fatalisme ? Une forme de honte ?\nÀ ta connaissance, y a-t-il des choses trash comme des photos détournées, des images ou vidéos porno qui circulent sur les réseaux sociaux ou dans certaines boucles de discussion ? L'une de vous a-t-elle déjà eu affaire à un exhibitionniste ou à un voyeur ?\nDirais-tu que tu as fait l’objet de harcèlement ou de chantage dans le cadre de ta vie d’étudiante ? Si oui, de quelle nature ?",
    ...
    "Quels sont à tes yeux les obstacles aux procédures de signalement de violences auprès des établissements ? Sont-elles connues et adaptées quand on est témoin d’actes de violence ? Que changerais-tu si tu le pouvais ? \nQui sont les mieux placées pour améliorer la situation ? Les personnes de l’administration ? Des associations de ton école ?  Des personnes externes ? Lesquelles ?",
    "**Si tu avais un message à faire passer à la direction de ton école, quel en serait le contenu ?**",
    ...
    "**Bonjour à toutes, c'est déjà le 5ème jour et il est temps de faire un peu le bilan.\nQue retiens-tu des derniers jours ? **",
    ...
    "**En conclusion, as-tu eu l'occasion de t'exprimer comme tu le souhaitais dans le cadre de ce forum ?**",
